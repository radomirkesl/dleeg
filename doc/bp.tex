...
% TODO: What exactly were they using?

\section{Deep Learning on EEG Studies}

% TODO: Title this and edit to fit here better but still relate to the DS
...
% TODO: what now?
used for online evaluation in the within-subject analysis. However, only EEGNet surpassed the online evaluation in a statistically significant way, achieving accuracy of $75.47 \pm 10.8\%$, while online achieved $68.10 \pm 12.6\%$.\@
...
This appears to be the only extensive study, conducted on the Stieger-62 dataset so far (and reasonably accessible to us), which leaves a decent amount of space for further studies while providing a possibility of comparison.
