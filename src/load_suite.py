...
if __name__ == "__main__":
    ...
    suite.load_and_process(
        "all_50-64",
        SubjectSpec(age_range=(50, 64)),
    )
    suite.load_and_process(
        "rh_18-30",
        SubjectSpec(age_range=(18, 30), handedness="R"),
    )
    suite.load_and_process(
        "rh_30-50",
    ...
    suite.load_and_process(
        "rh_50-64",
        SubjectSpec(age_range=(50, 64), handedness="R"),
    )
    suite.load_and_process(
        "f_18-30",
        SubjectSpec(age_range=(18, 30), gender="F"),
    )
    suite.load_and_process(
        "f_30-50",
    ...
    suite.load_and_process(
        "f_50-64",
        SubjectSpec(age_range=(50, 64), gender="F"),
    )
    suite.load_and_process(
        "meditation",
